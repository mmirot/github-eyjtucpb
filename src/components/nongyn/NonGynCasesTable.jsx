...
const NonGynCasesTable = ({ formData, handleChange, handleSubmit, onOpenMultiEntryModal }) => {
...
NonGynCasesTable.propTypes = {
  ...
  onOpenMultiEntryModal: PropTypes.func.isRequired
};
